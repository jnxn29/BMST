...
if __name__ == '__main__':
    ...
    MIni_TRAIN_MEAN = (0.4781772494316101, 0.4461788237094879, 0.39663946628570557)
    Mini_TRAIN_STD = (0.26830121874809265, 0.25961804389953613, 0.26862990856170654)
    ...
    if args.gpu:
        filename = f"MiniI48_{args.net}_lr{args.lr}_{args.merge}to1{timestamp}_b{args.b}_gpu4090.csv"
    else:
        filename = f"MiniI48_{args.net}_lr{args.lr}_{args.merge}to1_{timestamp}_b{args.b}_cpu.csv"
    if args.fp16:
        filename = f"MiniI48_{args.net}_lr{args.lr}_{args.merge}to1_{timestamp}fp16_b{args.b}_gpu4090.csv"
