...
if __name__ == '__main__':
    ...
    if args.gpu:
        filename = f"cifar100{args.net}_lr{args.lr}_{args.merge}to1_{timestamp}_gpu.csv"
    else:
        filename = f"cifar100{args.net}_lr{args.lr}_{args.merge}to1_{timestamp}_cpu.csv"
    if args.fp16:
        filename = f"cifar100{args.net}_lr{args.lr}_{args.merge}to1_{timestamp}fp16_gpu.csv"
